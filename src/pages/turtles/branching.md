...
Δείτε τον παρακάτω κώδικα που δημιουργεί την εικόνα [@fig:turtles:y]. Έχει σχεδιαστεί εύκολα με turtle και την εντολή branch.
...
![Μία εικόνα της οποίας ο σχεδιασμός με το turtle και την εντολή branch είναι εύκολος.](src/pages/turtles/y.pdf+svg){#fig:turtles:y}
...
και παρουσιάζεται γραφικά στην εικόνα [@fig:turtles:flatMap]. Μπορούμε να δούμε ότι η `flatMap` έχει τον κατάλληλο τύπο ώστε να συνδυάσει την `rule` με την `List[Instruction]` για να ξαναδημιουργήσει την `List[Instruction]`.
...
Δημιουργήστε την εικόνα [@fig:turtles:branching] και την [@fig:turtles:koch-curve].
