...
<div class="solution">
Η `chessboard` είναι μία δομημένη αναδρομή σε φυσικούς αριθμούς, οπότε μπορούμε να γράψουμε απευθείας τον σκελετό της.
...
Μπορεί να φαίνεται αρκετά περίπλοκο αλλά μπορούμε να διασπάσουμε την δομή του σε μία μορφή την οποία μπορούμε να φτιάξουμε χρησιμοποιώντας δομημένη αναδρομή σε φυσικούς αριθμούς.
