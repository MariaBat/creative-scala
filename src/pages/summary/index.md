...
Η `draw` έχει τον ρόλο του *διερμηνέα* για τις εικόνες μας,
...
Ξεχωρίζοντας την άμεση τιμή και τον διερμηνέα,
έχουμε την δυνατότητα να αλλάξουμε τον τρόπο που γίνεται η μετάφραση.
Το Doodle έχει ήδη δύο διερμηνείς.
Ο ένας από αυτούς σχεδιάζει στην δομή της Java2D
ενώ ο άλλος στον καμβά της HTML.
Μπορείτε να φανταστείτε και άλλους διερμηνείς για άλλες χρήσεις, όπως για παράδειγμα
