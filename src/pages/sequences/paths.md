...
Τώρα που ξέρουμε κάποια πράγματα για τα μονοπάτια, πώς μπορούμε να τα δημιουργήσουμε και εμείς στο Doodle? Παρακάτω μπορείτε να δείτε τον κώδικα που δημιούργησε την εικόνα [@fig:pictures:open-closed-paths].
...
`lineTo(Point)`                      Σχεδίασε μία ευθεία γραμμή   `lineTo(cartesian(2, 2))`
                                     μέχρι το `Point`

`curveTo(Point, Point, Point)`       Σχεδίασε μία καμπύλη.         `curveTo(cartesian(1,0), cartesian(0,1), cartesian(1,1))`
                                     Τα δύο πρώτα σημεία
...
![Ένα τρίγωνο, ένα τετράγωνο και ένα πεντάγωνο σχεδιασμένα από μονοπάτια.](./src/pages/sequences/polygons.pdf+svg){#fig:sequences:polygons}
