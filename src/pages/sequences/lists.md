...
Ίσως θυμάστε ότι όταν μιλήσαμε πρώτη φορά για την δομημένη αναδρομή σε φυσικούς αριθμούς, είπαμε ότι θα μπορούσαμε να μετατρέψουμε την αναδρομική τους δομή σε οποιαδήποτε άλλη αναδρομική δομή.
