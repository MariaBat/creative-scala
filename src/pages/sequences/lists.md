...
Χρησιμοποιώντας τον ίδιο σκελετό μπορούμε να υπολογίσουμε το ίδιο εύκολα το μήκος μίας λίστας `List[Int]` όπως και μίας λίστας `List[HairyYak]` αλλά μέχρι τώρα δεν ξέρουμε πώς να ορίσουμε μία λίστα της οποίας δεν μας ενδιαφέρει ο τύπος των στοιχείων της.
...
(Μπορείτε να καταλάβετε πώς το καταφέραμε; Βοήθεια: Είναι απαραίτητο να περάσουμε, για παράδειγμα, το `start` σε κάθε κλήση της `makeColor` όταν δεν αλλάζει;)
