...
Για να καταλάβετε πως λειτουργεί το `at` και γιατί πρέπει να τοποθετήσουμε τις κουκκίδες τη μία πάνω στην άλλη χρησιμοποιώντας το `on`, πρέπει να ξέρουμε πως χειρίζεται τις διατάξεις το Doodle.
...
- πως να γράφουμε τον τύπο μίας μεθόδου ως παράμετρο μεθόδου, και
- πως να διαχωρίζουμε την κλήση μίας μεθόδου (πχ την `rose(0.degrees)`) από την αναφορά στην αντίστοιχη μέθοδο.
