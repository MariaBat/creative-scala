...
Στη Scala υπάρχουν διάφορες μορφές κυριολεκτικών εκφράσεων. Μια που έχουμε ήδη δει είναι το `Int`. Για τους *αριθμούς κινητής υποδιαστολής*, χρησιμοποιείται ένας διαφορετικός τύπος και μια διαφορετική σύνταξη. Αυτό αντιστοιχεί στο πως αντιλαμβάνεται ο υπολογιστής τους πραγματικούς αριθμούς. Δείτε ένα παράδειγμα:
...
Καλοί οι αριθμοί, αλλά τι γίνεται με το κείμενο; Η Scala μας παρέχει τον τύπο `String` για αναπαράσταση μιας σειράς χαρακτήρων. Μπορούμε να γράψουμε κυριολεκτικές εκφράσεις strings βάζοντας το περιεχόμενό τους μέσα σε διπλά εισαγωγικά ("...").
