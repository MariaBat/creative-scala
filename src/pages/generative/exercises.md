...
<div class="solution">
Μπορούμε να μετατρέψουμε ένα σημείο σε εικόνα χρησιμοποιώντας την μέθοδο `point` που υπάρχει παρακάτω.
Παρατηρήστε ότι κάναμε το κάθε σημείο του σχεδίου σχεδόν διαφανές---έτσι γίνεται ευκολότερο να δει κανείς πού συγκεντρώνονται τα περισσότερα σημεία.
...
Είναι λίγο μεγαλύτερος από όσα έχουμε δει ως τώρα. Θα πρέπει να καταλαβαίνετε πώς δουλεύουν τα στοιχεία που τον αποτελούν.
