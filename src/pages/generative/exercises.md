...
Μπορείτε να χρησιμοποιήσετε την συνάρτηση που φτιάξαμε για τα τριαντάφυλλα (την είδαμε σε προηγούμενο κεφάλαιο) ή μπορείτε να φτιάξετε μία δική σας από την αρχή. Παρακάτω μπορείτε να δείτε τον ορισμό της rose.
...
Παρακάτω μπορείτε να δείτε ένα παράδειγμα της `andThen` στο οποίο φαίνεται πώς μπορεί να υπολογιστεί η τέταρτη δύναμη ενός αριθμού χρησιμοποιώντας το τετράγωνό του.
